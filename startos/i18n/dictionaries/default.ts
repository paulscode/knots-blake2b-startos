...
const dict = {
  ...
  Chain: 3105,
  'Waiting for the node to answer RPC': 3106,
  'This node reports no BLAKE2b activation. It is not running the fork.': 3107,
  'This build activates BLAKE2b at a different height than expected on mainnet': 3108,
  'Following the BLAKE2b chain': 3109,
  Syncing: 3110,
  'Stalled just below the BLAKE2b activation height, which means this node has no peers on the fork. It normally finds them through the DNS seeds. Add one directly under Peers if your network blocks DNS.': 3111,
  'Before the BLAKE2b activation': 3112,
} as const
